...
```bash
npx skills add witify/skills --skill=resolving-merge-conflicts
```
...
[Source](https://github.com/witify/skills/tree/main/skills/engineering/resolving-merge-conflicts)
