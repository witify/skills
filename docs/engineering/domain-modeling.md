...
```bash
npx skills add witify/skills --skill=domain-modeling
```
...
[Source](https://github.com/witify/skills/tree/main/skills/engineering/domain-modeling)
