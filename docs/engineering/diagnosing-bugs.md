...
```bash
npx skills add witify/skills --skill=diagnosing-bugs
```
...
[Source](https://github.com/witify/skills/tree/main/skills/engineering/diagnosing-bugs)
