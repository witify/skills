...
```bash
npx skills add witify/skills --skill=grill-with-docs
```
...
[Source](https://github.com/witify/skills/tree/main/skills/engineering/grill-with-docs)
