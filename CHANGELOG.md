...
- [`4198e57`](https://github.com/witify/skills/commit/4198e5762e06d52c8a8b8ec2a89b26a38d049e10) Thanks [@francoislevesque](https://github.com/francoislevesque)! - New `witify-doctor` skill (engineering, user-invoked): a check-up you validate item by item, organised in **levels** by migration cost so an old fork can start where it stands and climb one rung per session — the doctor never skips a level.
...
- [`4e3d790`](https://github.com/witify/skills/commit/4e3d790b54b94c70b4e7c572a3361f81745366f0) Thanks [@francoislevesque](https://github.com/francoislevesque)! - Synced the vendored skills with upstream [mattpocock/skills](https://github.com/mattpocock/skills) up to `6654f6b`.
