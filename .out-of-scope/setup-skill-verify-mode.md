# Verify/Check Mode for `setup-witify-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-witify-skills`.
...
- #106 — Feature request: verify/check mode for setup-witify-skills
